...
| Newton target runtime | partial | Layered OpenUSD synthetic smoke compiler plus Newton 1.5.0 Apple CPU synthetic and Room-01 proposal contact/reset receipts; all Room-01 authority remains false and USD import/product integration are untested | Solver-neutral client, worker supervisor, USD import, promoted-collider and local/remote parity, cutover, and Rapier removal |
