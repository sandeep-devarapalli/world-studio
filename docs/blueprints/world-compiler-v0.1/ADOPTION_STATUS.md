...
| Room-01 hybrid canonical World R3 | partial | Accepted 168-camera registration plus a checksum-bound Spirula Gaussian, held measured TSDF/hybrid surface, and held collider candidate now compile, publish, and reopen through the canonical store | Validate physical scale, occupancy/free space, doorway and wall continuity, promote a collider explicitly, then run the reference route; no current evidence grants physics authority |
