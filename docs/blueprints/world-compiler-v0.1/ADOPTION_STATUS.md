...
| Newton target runtime | partial | Layered OpenUSD synthetic smoke compiler plus a Newton 1.5.0 Apple CPU contact/reset receipt; no Room-01 authority or product integration | Solver-neutral client, worker supervisor, experimental Room-01 proxy, promoted-collider and local/remote parity, cutover, and Rapier removal |
